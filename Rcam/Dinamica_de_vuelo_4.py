...
def RCAM_model(X:np.ndarray, U:np.ndarray, rho:float) -> np.ndarray:
    ...
    Xac = 0.12 * cbar # m - x pos of aerodynamic center 
    Yac = 0.0 # m - y pos of aerodynamic center 
    Zac = 0.0 # m - z pos of aerodynamic center 
    Xapt1 = 0 # m - x position of engine 1 
    Yapt1 = -7.94 # m - y position of engine 1 
    Zapt1 = -1.9 # m - z position of engine 1 
    Xapt2 = 0 # m - x position of engine 2 
    Yapt2 = 7.94 # m - y position of engine 
    Zapt2 = -1.9 # m - z position of engine 
    g = 9.81 # m/s2 - gravity
...
# Controls (def_A, def_E, def_R, th1, th2)
U = np.array([0.0, -0.1, 0.0, 0.0, 0.08])
...
plt.suptitle('Longitudinal motion for engine shutdown'); plt.tight_layout()
plt.show()
...
plt.suptitle('Lateral-directional motion for engine shutdown'); plt.tight_layout()
plt.show()